class Interpolator4x4 extends Interpolator
{
   ...
   Interpolator4x4(int horizontalSamples, int verticalSamples, int horizontalMultiplier, int verticalMultiplier, String name, float contrastLeft, float contrastRight)
   {
