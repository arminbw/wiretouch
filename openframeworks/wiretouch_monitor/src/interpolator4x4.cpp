...
double wtmInterpolator4x4::interp_func(double p0, double p1, double p2, double p3, double f)
{
    return 0.0;
}

double wtmInterpolator4x4::interpolate4(int x, int y, int ix, int iy, float fx, float fy)
{
...
void wtmInterpolator4x4::beginInterpolate4(int x, int y)
{
