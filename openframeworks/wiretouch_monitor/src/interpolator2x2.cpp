...
double wtmInterpolator2x2::interp_func(double a, double b, float f)
{
    return 0.0;
}

double wtmInterpolator2x2::interpolate4(int x, int y, int ix, int iy, float fx, float fy)
{
...
void wtmInterpolator2x2::beginInterpolate4(int x, int y)
{
